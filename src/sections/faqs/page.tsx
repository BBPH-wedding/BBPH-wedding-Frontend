...
const FAQs = () => {
  return (
    <>
      <section className="h-auto pt-14 sm:pt-32 bg-[#f1f2ec] flex flex-col items-center justify-center text-center px-5 text-sm md:text-lg">
        <div className="mb-20">
          <Titles title="FAQs" color="text-primaryGreen" size="large" />
