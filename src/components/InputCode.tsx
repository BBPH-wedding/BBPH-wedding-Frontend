    ...
    <div className="flex flex-wrap justify-center gap-2 md:gap-3">
      {Array.from({ length }).map((_, index) => (
        <input
          ...
          className="w-10 h-10 text-lg font-semibold text-center transition-all duration-200 border-2 border-gray-300 rounded-lg sm:w-12 sm:h-12 md:w-14 md:h-14 sm:text-xl md:text-2xl focus:outline-none focus:border-blue-500"
